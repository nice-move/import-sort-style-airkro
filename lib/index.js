...
const isStylesModule = imported => Boolean(imported.moduleName.match(/\.(s?css|less|postcss)$/));
...
exports.default = (styleApi) => {
    ...
    return [
        ...
        {
            sortNamedMembers,
            match: moduleName(oneOfModule(['qs', 'axios', 'classnames', 'immutable', 'lodash', 'md5', 'flat', 'is-url']))
        },
        {
            sortNamedMembers,
